  ...
  return (
    <div>
          <div className='flex justify-center'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-1.5 w-[95%] md:w-[60%] lg:w-[36%] rounded-xl border border-neutral-500 px-6 py-4 mt-14 m-8 lg:m-9 shadow-[0_0_15px_rgba(0,0,0,0.2)]'>
